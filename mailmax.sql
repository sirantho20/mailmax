...
INSERT INTO `account` VALUES (1,'Softcube Limited','softcube.co','mail.softcube.co',2,'aafetsrom@softcube.co',244304946,'2013-04-22','a','0000',1);
INSERT INTO `account` VALUES (2,'Bullion Investment Group','bullion.com.gh','mail.bullion.com.gh',3,'aafetsrom@softcube.co',244304946,'2013-04-22','a','82d5220f-e386-469b-ab9b-dbb07b30dcc1',2);
INSERT INTO `account` VALUES (3,'Bureau of Market & Social Research','marketresearch.com.gh','mail.marketresearch.com.gh',3,'aafetsrom@softcube.co',244304946,'2013-04-22','a','82d5220f-e386-469b-ab9b-dbb07b30dcc1',2);
...
--
CREATE TABLE `interested_clients` (   `id` int AUTO_INCREMENT NOT NULL, `hash_id` varchar(200) not null,   `email` varchar(45) DEFAULT NULL, `firstname` varchar(45) DEFAULT NULL, `lastname` varchar(45) DEFAULT NULL, `added_date` datetime DEFAULT NULL,PRIMARY KEY(`id`) );
...
INSERT INTO `package` VALUES (1,'Basic',50,5000,12,250,NULL),(2,'Standard',100,10000,12,450,1),(3,'Premium',250,75000,12,895,1);
...
INSERT INTO `resellerAccounts` VALUES (1,'Softcube Limited','softcube.co','mail.softcube.co',NULL,'aafetsrom@softcube.co','0244304946','a');
INSERT INTO `resellerAccounts` VALUES (2,'Bullion Investment Group','bullion.com.gh','mail.bullion.com.gh',NULL,'aafetsrom@softcube.co','0244304946','a');
...
INSERT INTO `users` VALUES (1,'softcube','Anthony','ddc5f5e86d2f85e1b1ff763aff13ce0a','2013-04-22','aafetsrom@softcube.com','Afetsrom',2147483647,1,'y','y');
INSERT INTO `users` VALUES (2,'bullion','Anthony','ddc5f5e86d2f85e1b1ff763aff13ce0a','2013-04-22','aafetsrom@softcube.com','Afetsrom',2147483647,2,'n','n');
...
-- Dump completed on 2013-05-10 16:18:30
