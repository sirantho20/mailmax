...
class PackageController extends Controller
{
	 ...
	 */
        ...
        {
            $side = new sideBar();
            $side->addList('Manage Accounts', $this->createUrl('reseller/admin'), 'manageclientaccount')
                 ->addList('Packages', $this->createUrl('admin'), 'manageResellerPackages');
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Package']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success','Pckage '.$model->package_name.' successfully created');
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Package']))
		{
			...
			if($model->save())
                        {
                            Yii::app()->user->setFlash('success','Package update successfull');
                            $this->redirect(array('admin','id'=>$model->id));
                        }
		}
